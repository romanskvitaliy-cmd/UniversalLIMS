...
> **Для нового агента.** Оновлено: 2026-05-25  
...
## 6. Що НЕ реалізовано (беклог, погоджено як бажана логіка)

Замовник описав **нормальну** операційну модель; у коді **ще немає**:

### 6.1 Повторна активація старої версії (наприклад v5)
...
### 6.3 Відображення «Активний» в UI
...
## 7. Сценарій «відточення шаблону» (еталон для тестів)
...
## 11. Стартовий prompt для агента
