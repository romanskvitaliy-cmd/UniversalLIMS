        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var order = await orderQuery
            .Select(item => new
            {
                ...
                item.ReferralNumber,
                item.CustomerId,
                CustomerKind = item.Customer.Kind,
                CustomerFullName = item.Customer.FullName,
                CustomerOrganizationName = item.Customer.OrganizationName,
                CustomerContactPhone = item.Customer.ContactPhone,
                CustomerEmail = item.Customer.Email,
                CustomerAddress = item.Customer.Address,
                CustomerEdrpou = item.Customer.Edrpou,
                CustomerRnokpp = item.Customer.Rnokpp,
        ...
        return new OrderDetailDto
        {
            ...
            CustomerKind = order.CustomerKind,
            CustomerFullName = order.CustomerFullName,
            CustomerOrganizationName = order.CustomerOrganizationName,
            CustomerContactPhone = order.CustomerContactPhone,
            CustomerEmail = order.CustomerEmail,
            CustomerAddress = order.CustomerAddress,
            CustomerEdrpou = order.CustomerEdrpou,
            CustomerRnokpp = order.CustomerRnokpp,
